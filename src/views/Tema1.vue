...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    #t_1_1.titulo-segundo
      h2 1.1 ¿Qué es la investigación de mercados?
    .contenedor.bg2
    ...
    AcordionA.mb-5(tipo="b" clase-tarjeta="tarjeta fcb")
      .px-5(titulo="Investigación exploratoria")
        .row.mb-4
          .col-lg-6
            figure
              img(src='@/assets/curso/t1/f3.svg' alt='Personas sentadas en una mesa')
          .col-lg-6
            p El no conocer amplia y detalladamente los cursos de acción que soportan cualquier decisión, le sugiere al gerente de mercadeo la necesidad de adquirir conocimientos preliminares para lograr una formulación más precisa de un problema u oportunidad  identificados; también le indica que necesita adquirir una mejor perspectiva de las variables que intervienen en una situación; en fin, esa ignorancia natural acerca de algo desconocido impele al gerente a enriquecer su conocimiento sobre la situación, a aprender de los orígenes y las causas de los problemas que dan forma a la situación en estudio.
      ...
      .px-5(titulo="Investigación concluyente")
        p A su vez, cuando se tienen previamente identificados los cursos de acción, el gerente requiere información que le brinde la posibilidad de evaluar dichos cursos de acción, ponderando su respectivo nivel de incertidumbre y posteriormente seleccionar el mejor de ellos, el óptimo para la toma de una decisión. En esta oportunidad el problema de decisión se enfrenta a través del diseño y desarrollo de una investigación concluyente.
        .row.mb-4
          .col-lg-6
            figure
              img(src='@/assets/curso/t1/f4.svg' alt='Personas con laptop y estadísticas')
          .col-lg-6
            p El hecho fundamental, que, sin lugar a dudas, legitima que se llevó a cabo una investigación exploratoria o una concluyente, lo constituye el método de selección de los elementos que aportaron los datos o la información necesaria en el estudio de mercado. Al respecto, Plazas (2011) plantea que
    ...
    .contenedor.bg4.ofVisible.mb-5
      .col-lg-10.mx-auto.mb-5
        ...
        .row.align-items-center
          .col-lg-6
            figure
              img(src='@/assets/curso/t1/f5.svg' alt='tipos de investigación')
              figcaption Fuente: Plazas, 2011, p.39.
          .col-lg-6
            figure
              img(src='@/assets/curso/t1/f6.svg' alt='Personas trabajando en una mesa')
        .row.align-items-center.mb-5
          .col-lg-5.me-auto
        ...
        p.mb-5 A continuación se ilustra un ejemplo de la aplicación del método de investigación concluyente para un estudio del mercadeo de productos de pastelería y repostería, en el cual, mediante una encuesta, se busca ponderar las variables objetos de estudio que inciden en la variables ventas e ingresos de este negocio, como son, conocimiento y preferencias del consumidor sobre productos, así como las frecuencias de visita, inversión en cada visita, sitio de compra, horarios habituales de consumo y bebidas con las que usualmente acompaña estos productos de repostería.
        .col-lg-6.mb-5
          a.anexo.mb-4(:href="obtenerLink('/downloads/prueba.pdf')" target="_blank")
            .anexo__icono
              img(src="@/assets/template/icono-pdf.svg")
            .anexo__texto
              p Ejemplo encuesta método e investigación concluyente
        .row.align-items-center.mb-5
          .col-lg-5
            p En la investigación concluyente existen dos grandes grupos: la concluyente descriptiva y la concluyente causal. 
            p La investigación concluyente descriptiva es apropiada cuando, además de la necesidad de tomar una decisión, se desea detallar, pormenorizar, describir y cuantificar las características de la situación en estudio; también es oportuna para detectar asociación o relación entre variables y cuantificar el grado de esa dependencia; por otro lado, la investigación concluyente descriptiva es conveniente siempre que se pretenda llevar a cabo predicciones o pronósticos respecto a la ocurrencia de algún fenómeno de mercadeo. 
          .col-lg-7
            figure
              img(src='@/assets/curso/t1/f8.svg' alt='cuadro relacionado').mb-4
              figcaption Fuente: Plazas, 2011, p 40
      .col-lg-8.mx-auto
        .cajon.color-primario.p-4.mb-5
          p.mb-0 De acuerdo con Plazas (2011), la investigación concluyente causal posibilita conocer y cuantificar las relaciones de causa y efecto existentes entre las variables presentes en las decisiones de mercadeo; permite entender cómo se da esa relación entre los aspectos que ocasionan un fenómeno y el efecto que produce. 
    Separador
    ...
    .tabla-a.color-secundario.mb-5 
      table
        caption Fuente: Dos Santos, 2017, p. 57
        thead
          tr
            th TÉCNICA
            th DESCRIPCIÓN
        ...
        tbody
          tr
            td Grupo focal 
            td Pequeños grupos de discusión dirigidos por un moderador capacitado 
            td Puede ser rápida<br>Múltiple perspectiva<br>Flexibilidad<br>Roles grupales
            td Resultado no general<br>Veta temas Sensibles<br>Costosa
          tr
            td Entrevista
            td Entrevista individual profunda cara a cara
            td Profundidad por caso<br>Comprensión del comportamiento 
            td No generalizable<br>Muy caro por cada entrevista
          tr 
            td Observación 
            td Se registra la observación de fenómenos
            td Es discreta<br>Patrones reales 
            td Puede ser cara<br>Poca profundidad
          tr
            td Pseudocompra (mystery shopper)
            td Visitas anónimas de simulación de compra
            td Evaluación real<br>Directa
            td No generalizable<br>Presión y evaluación
          tr 
            td Técnicas proyectivas
            td Muestran imágenes ambiguas
            td Flexible<br>Trata temas sensibles
            td Alta dependencia de la interpretación
    Separador
    #t_1_4.titulo-segundo
      h2 1.4 Métodos e instrumentos de recolección de datos
    .contenedor.bg7.ofVisible.mb-5
      .col-lg-10.mx-auto
        .row.align-items-center.justify-content-between
          .col-lg-6
            p Los instrumentos de investigación de mercados se constituyen en un recurso muy importante, en la medida que facilitan el acercamiento a la solución de un problema, mediante el aporte de datos derivados de la información recolectada con su aplicación. De igual importancia para la investigación resulta la determinación de un modelo conducente a la valoración de la información obtenida, por medio de la formulación de concepciones de herramientas que favorezcan y dinamicen estos procesos. 
            p De allí que los instrumentos se piensen atendiendo a los actores que intervienen en el proceso, desde sus necesidades, intereses y motivaciones. 
            .cajon.color-primario.p-4
              p.mb-0 Entendida la Investigación de Mercados (IM) como la búsqueda ordenada, sistemática y objetiva de la información requerida en la identificación y análisis de necesidades de los consumidores, se define como instrumento a la herramienta utilizada para ejecutar tal fin.
          .col-lg-5
            figure
    ...
    TabsA.color-acento-contenido.mb-5
      .tarjeta.color-acento-contenido.fcp15.p-4(titulo="Pautas")
        ...
        .row.align-items-center
          .col-lg-6
            figure
              img(src='@/assets/curso/t1/f17.svg' alt='Personas trabajando')
          .col-lg-6
            ul.lista-ul
              li 
                i.fas.fa-play.cs
      ...
      .tarjeta.color-acento-contenido.fcp15.p-4(titulo="Cualidades básicas")
        ...
        .row.align-items-center
          .col-lg-6
            figure
              img(src='@/assets/curso/t1/f18.svg' alt='Personas trabajando')
          .col-lg-6
            ul.lista-ul
              li 
                i.fas.fa-play.cs
      ...
      .tarjeta.color-acento-contenido.fcp15.p-4(titulo="Tipos de encuesta")
        ...
        .row.align-items-center.mb-4
          .col-lg-2
            figure
              img(src='@/assets/curso/t1/f19.svg' alt='icono correo')._88px.mx-auto
          .col-10
            p.mb-0 Encuesta por correo: es un cuestionario, máximo de cinco páginas, aplicado por los propios encuestados y que después se envía por medio de correo, ya sea tradicional o electrónico, a la empresa investigadora o empresa beneficiada.
        .row.align-items-center.mb-4
          .col-lg-2
            figure
              img(src='@/assets/curso/t1/f20.svg' alt='icono teléfono')._88px.mx-auto
          .col-10
            p.mb-0 Encuesta por teléfono: es una encuesta, máximo de diez minutos, que busca información mediante contacto telefónico, entre un entrevistador y las personas seleccionadas para tal fin, llamadas encuestados.
        .row.align-items-center.mb-4
          .col-lg-2
            figure
    ...
    .contenedor
      .row.align-items-center.mb-5
        .col-lg-4
          figure
            img(src='@/assets/curso/t1/f23.svg' alt='persona observando')
        .col-lg-7
          p Consiste en el reconocimiento y registro sistemático del comportamiento de personas, objetos y eventos, sin comunicarse con ellos. Los observadores generalmente observan acciones físicas, expresiones verbales, faciales y corporales, tonos de voz, ubicaciones especiales, tiempos de espera, objetos físicos y registros fotográficos.
          p Existen cinco tipos de observación: 1. Observación natural o artificial; 2. Observación oculta o no oculta; 3. Observación estructurada o no estructurada; 4. Observación directa o indirecta; 5. Observación humana o mecánica. 
    .col-lg-10.mx-auto.px-4
    ...
    .col-lg-7.mx-auto.mb-5
      .row.align-items-center
        .col-lg-5
          figure
            img(src='@/assets/curso/t1/f26.svg' alt='Barras estadísticas')
        .col-lg-7
          p Proceso de recopilar, ordenar, analizar e interpretar datos, hechos y observaciones de un fenómeno determinado. 
